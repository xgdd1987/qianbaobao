...
str += '.calendar{position:absolute;width:160px!important;width /**/:162px;height:184px!important;height /**/:164px;background-color:'+this.style.bodyBackColor+';border:1px solid ' + this.style.borderColor + ';left:0px;top:0px;z-index:9999;}\n';
...
str += '.cdrWatermark{position:absolute;left:0px;top:55px;width:170px;font-family: Arial Black;font-size:50px;color:'+this.style.watermarkColor+';z-index:1;text-align:center;}\n';
...
str += '.cdrBody{width:160px;height:122px!important; height /**/:110px;font-size:12px;cursor:pointer;color:' + this.style.bodyFontColor + ';}\n';
...
str += 'html>body #Calendar{width:162px;174px;}';
str += '</style>\n';	
return str;
};
Calendar.prototype.getHeader = function()
{
var str = '<table Author="alin" border=0 class="cdrHeader" cellSpacing="2" cellPadding="0"><tr Author="alin" align="center">\n';
