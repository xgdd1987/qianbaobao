		...
		<div id="MainBody">
			<div id="MainCount">
				<div id="MainBanner">
					...
					<div id="MainB4">&nbsp;您的当前位置: <a href="<?php echo site_url('group/index');?>">群组</a>&gt;&gt;<a href="<?php echo site_url('group/topicList2/'.$_SESSION['groupid'].'/'.$_SESSION['groupName']);?>"><?php echo $_SESSION['groupName'];?></a>&gt;&gt;修改话题</div>
				</div>
			...
			<div id="MainList">
				<div id="MainAddCashForm" style="height:550px;"><form method="post" onsubmit="return checkform();">
					...
					<label for=Title>标题：</label><input type="text" name="name" id="name" value="<?php if(set_value('name')=='') echo $topic[0]['name'];else echo set_value('name');?>" maxlength="50" style="width:300px;" class="inputText"><br />
					<?php echo $info;?><br />
