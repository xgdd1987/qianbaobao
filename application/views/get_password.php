			...
			<div id="MainList">
				<div id="MainAddCashForm" style="text-align: center;">
					...
					<table align="center" border=0>
						...
						<tr height="30">
							<td>注册时的邮箱：</td>
							<td><input type="text" name="email" id="email" value="<?php echo set_value('email');?>" maxlength="80" class="inputText"></td>
							<td><?php echo form_error("email"); ?></td>
						</tr>
						<tr height="50">
							<td><input name="Submit" type="submit" id="Submit" value="发送邮件" class="AddBtn"></td>
