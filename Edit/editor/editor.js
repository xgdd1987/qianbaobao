...
EDiaryEditor = {
	...
	initControl: function (bWordMode, sContent) {
		...
		function viewDialog(el, Act) {
			...
			var win;
			if(window._isIE) {			
				window.showModalDialog("editor/"+Act+".html", window, "dialogWidth: 400px; dialogHeight: 200px; help: no; scroll: no; status: no");
			}else {
				win = window.open("editor/"+Act+".html", null, "Width=400,Height=200,left="+(window.screen.availWidth-400)/2+",top="+(window.screen.availHeight-200)/2+"");
